...
$result1 = $mysqli_host_3->query($query) or die($mysqli_host_3->error.__LINE__);
$result2 = $mysqli_astrapi->query($query) or die($mysqli_astrapi->error.__LINE__);
...
while ( list ( $key, $val ) = each ( $result ) )
{
	...
	$result3 = $mysqli_host_3->query($query3) or die($mysqli_host_3->error.__LINE__);
